...
resource "aws_iam_policy_attachment" "config_role_policy_attachment" {
  # note that "name" should not be required
  name       = "ConfigRolePolicyAttach"

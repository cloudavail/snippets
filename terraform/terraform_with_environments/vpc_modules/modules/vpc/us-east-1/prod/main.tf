...
resource "aws_subnet" "Public05-prod" {
  vpc_id            = "${aws_vpc.cloudavail-prod.id}"
...
resource "aws_subnet" "Public06-prod" {
  vpc_id            = "${aws_vpc.cloudavail-prod.id}"
...
resource "aws_subnet" "Private05-prod" {
  vpc_id            = "${aws_vpc.cloudavail-prod.id}"
...
resource "aws_subnet" "Private06-prod" {
  vpc_id            = "${aws_vpc.cloudavail-prod.id}"
...
resource "aws_subnet" "NAT05-prod" {
  vpc_id            = "${aws_vpc.cloudavail-prod.id}"
...
resource "aws_subnet" "NAT06-prod" {
  vpc_id            = "${aws_vpc.cloudavail-prod.id}"
...
resource "aws_route_table_association" "Public05-prod" {
  subnet_id      = "${aws_subnet.Public05-prod.id}"
  route_table_id = "${aws_route_table.PublicRoute-prod.id}"
}

resource "aws_route_table_association" "Public06-prod" {
  subnet_id      = "${aws_subnet.Public06-prod.id}"
  route_table_id = "${aws_route_table.PublicRoute-prod.id}"
}
...
resource "aws_route_table_association" "Private05-prod" {
  subnet_id      = "${aws_subnet.Private05-prod.id}"
  route_table_id = "${aws_route_table.PrivateRoute-prod.id}"
}

resource "aws_route_table_association" "Private06-prod" {
  subnet_id      = "${aws_subnet.Private06-prod.id}"
  route_table_id = "${aws_route_table.PrivateRoute-prod.id}"
}
...
resource "aws_route_table_association" "NAT05-prod" {
  subnet_id      = "${aws_subnet.NAT05-prod.id}"
  route_table_id = "${aws_route_table.NATRoute-prod.id}"
}

resource "aws_route_table_association" "NAT06-prod" {
  subnet_id      = "${aws_subnet.NAT06-prod.id}"
  route_table_id = "${aws_route_table.NATRoute-prod.id}"
}